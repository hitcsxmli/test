 ...
 * 
 * @authors 李晓明
 * @email csxmli@126.com
 * @date    2015-11-29 14:32:36
 * @version 1.0
 * content 测试时间
 */

//定义一个常量，存储token的
define("TOKEN","timematch");
$wechatObj = new wechatCallbackapiTest();
$wechatObj->logger("Raa ".$_GET['echostr']);
    ...
    public function receiveEvent($object)
    {
        ...
        switch ($object->Event)
        {
            case "subscribe":
				...
				$User = $this->getJson($UserInfo);
				
                $content = "欢迎关注时间匹配小秘书 ";
                $content .= (!empty($object->EventKey))?("\n来自二维码场景 ".str_replace("qrscene_","",$object->EventKey)):"";
				$content .=$User['nickname'].$User['headimgurl'];
                break;
            case "unsubscribe":
                $content = "取消关注";
                break;
